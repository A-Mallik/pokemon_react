...
class App extends Component {
  // using Class Component gives us access to state. What is state? JS object with properties that we can access at any point in our class.
  // API:
  ...
  constructor() {
    ...
    // this.setState doesn't actually set the context without binding, which we want to connect to our App conmponent.
  ...
  handleChange = e => {
    // Arrow function automatically sets the context based on code its given, and this is seen as an arrow function and it automatically binds this.
    this.setState({ searchField: e.target.value }); //lexical scoping
  };
 ...
 */
        ...
        <Cardlist characters={filteredCharacters}>
          {" "}
          {/*//component recieves state as prop.  */}
          {
